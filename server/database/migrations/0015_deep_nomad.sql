...
CREATE INDEX `folder_parent_folder_idx` ON `folder` (`parent_folder_id`);--> statement-breakpoint
ALTER TABLE `file` ADD `previous_version_id` integer REFERENCES file(id);